...
unsigned int FontManager::fontTexutre() const noexcept
{
    return m_textureID;
}

const AsciiCharInfo* FontManager::asciiChar(char ch) const noexcept
{
    if (ch > 0 && ch < 128)
    {
...
bool FontManager::loadAsciiCharInfo(std::string& error) noexcept
{
    FT_Library ft;
